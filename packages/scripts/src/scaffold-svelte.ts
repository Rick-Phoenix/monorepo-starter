...
// const monorepoName = packageJSON.name;
//
...
//     },
//     dependencies: {
//       [`@${monorepoName}/utils`]: "workspace:*",
//     },
//     devDependencies: {
//       [`@${monorepoName}/linting-config`]: "workspace:*",
...
//   const eslintConfig =
//     `import { createEslintConfig } from '@${monorepoName}/linting-config' \n export default createEslintConfig({ svelte: true})`;
//
//   // Section - Prettier Config
//   const prettierConfig =
//     `import {prettierConfig} from '@${monorepoName}/linting-config' \n export default {...prettierConfig, plugins: [
...
//   await writeFile(
//     `${appdir}/package.json`,
//     JSON.stringify(sveltePackageJSON, null, 2),
//     "utf8",
//   );
...
//     path.resolve(import.meta.dirname, `../${monorepoName}.code-workspace`),
//     `apps/${appName}`,
//   );
//
//   if (withBunInstall) {
//     spawnSync(`cd ${appdir} && bun install`, { shell: true, stdio: "inherit" });
//   }
//
