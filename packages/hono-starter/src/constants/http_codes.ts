...
export const FOUND = 302; // Previously "Moved temporarily"
export const SEE_OTHER = 303;
export const NOT_MODIFIED = 304;
export const USE_PROXY = 305; // Deprecated
...
export const PAYMENT_REQUIRED = 402; // Experimental
...
export const UNPROCESSABLE_ENTITY = 422; // WebDAV / API Validation
export const LOCKED = 423; // WebDAV
export const FAILED_DEPENDENCY = 424; // WebDAV
export const TOO_EARLY = 425; // Experimental
